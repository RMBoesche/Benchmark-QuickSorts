...
void createStatsFile(const sortStats::data &stats, string ofnameStats)
{
    ...
    ofsStats << "Numero total de swaps: " << stats.swaps() << endl;
    ofsStats << "Numero total de chamadas recursivas: " << stats.calls() << endl;
    ofsStats << "Tempo de execucao: " << stats.time() << " ms" << endl;
